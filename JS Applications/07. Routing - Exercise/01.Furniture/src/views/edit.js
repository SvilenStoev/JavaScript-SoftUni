...
const formTemplate = (item, onSubmit, errorMsg, errors) => html`
    <div class="col-md-12">
        <h3>${errorMsg ? html`<div class="form-group error">${errorMsg}</div>` : ''}</h3>
    </div>
        ...
        <div class="row space-top">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input class="${'form-control' + (errors.material ? ' is-invalid' : '')} id=" new-material" type="text"
...
export function editPage(ctx) {
    ...
    const itemPromise = getById(itemId);
